...
void ColorProvider::setPalette(float baseHue, float baseSaturation, float baseValue, float maxHue, float maxSaturation, float maxValue, bool clockwise) {
    std::vector<ofColor> colors;
//    if (baseHue <= maxHue) {
//        for (int i = 0; i < NUM_NOTES; i++) {
//            colors.push_back(ofColor::fromHsb(static_cast<int>(ofMap(i, 0, NUM_NOTES, baseHue, maxHue)), 255, 255));
//        }
//    } else {
//        for (int i = 0; i < NUM_NOTES; i++) {
//            colors.push_back(ofColor::fromHsb(static_cast<int>(ofMap(i, 0, NUM_NOTES, baseHue, maxHue)), 255, 255));
